<!--
 - Merry Christmas to all fellow nerds who read this!
 -->
<!DOCTYPE html>
<html>
	<head>
		<?php global $title; $title = 'Christmas!'; require('headinfo.php'); ?>
	...
	<body>
		...
		<div class="wrapper">
			...
			<div class="main">
				<div class="col-sm-9">
					<h1 id="title">&#10052; Corn Hub &#10052;</h1> <!-- &#10052; = snow flake -->
					<p>&#10052; Merry Christmas! &#10052;</p>
					...
					<div class="center">
						<div id="Checkiday">
							<div id="Checkiday_Footer" class="checkiday">
								Holidays not loading ;(. Check them out at <a href="https://www.checkiday.com/" target="_blank">Checkiday.com</a>.
							</div>
						</div>
					</div>
					<br>
					...
					<!--
					<div class="gear">
						<img src="images/gear.png" alt="Settings" id="gear">
					</div>
		...
		<script type="text/javascript" src="js/snow.js"></script> <!--Snow (Note: It must be here so that it knows what the body element is.)-->
	</body>
</html>