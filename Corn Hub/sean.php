<!-- I was really bored when I made this page. -->
<!DOCTYPE html>
<html>
	<head>
		<?php global $title; $title = 'Sean'; require('headinfo.php'); ?>
	</head>
	...
	<body>
		...
		<div class="wrapper">
			...
			<div class="main">
				...
				<p><a href="#test">A lovely video of Sean Varner in his Dance Pants</a></p>
